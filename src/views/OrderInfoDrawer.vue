<template>
    <div class="orderInfoDrawer-page">
        <el-skeleton animated :loading="isLoading" :rows="8">
            <h2 class=" font-bold my-[11px]">客户信息</h2>
            ...
            <h2 class=" font-bold my-[11PX]">订单信息</h2>
            <div class="relative">
                <el-descriptions :column="2" border>
            ...
            <h2 class=" font-bold my-[11PX]">订单商品列表</h2>
...
.order-status-icon {
    ...
    @apply absolute right-0 bottom-0 text-red-600;
}
</style>